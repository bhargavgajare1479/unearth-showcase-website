...
const BLOCKS = [
    {
        ...
        content: (
            <div className="space-y-4">
                ...
                <p className="font-semibold">The main issues can be summarised as follows:</p>
                <div className="space-y-4 pt-2">
                    <div>
                        <h4 className="font-semibold text-foreground">1. Difficulty in recovering deleted data</h4>
                    ...
                    <div>
                        <h4 className="font-semibold text-foreground">2. Fragmented investigation tools</h4>
                    ...
                    <div>
                        <h4 className="font-semibold text-foreground">3. Growing complexity of digital evidence</h4>
                    ...
                    <div>
                        <h4 className="font-semibold text-foreground">4. Lack of integrated analysis platforms</h4>
    ...
    },
    {
        ...
        content: (
            <div className="space-y-4">
                ...
                <p className="font-semibold">The proposed solution focuses on the following key aspects:</p>
                <div className="space-y-4 pt-2">
                    <div>
                        <h4 className="font-semibold text-foreground">1. Reliable recovery of deleted data</h4>
                    ...
                    <div>
                        <h4 className="font-semibold text-foreground">2. Integrated forensic analysis</h4>
                    ...
                    <div>
                        <h4 className="font-semibold text-foreground">3. Metadata extraction and timeline reconstruction</h4>
                    ...
                    <div>
                        <h4 className="font-semibold text-foreground">4. Evidence integrity and verification</h4>
                    ...
                    <div>
                        <h4 className="font-semibold text-foreground">5. Intelligent content analysis</h4>
                    ...
                    <div>
                        <h4 className="font-semibold text-foreground">6. Accessible investigation tools</h4>
                        ...
                        return (
                            ...
                            >
                                <div>
                                    ...
                                    <div className="text-text-muted text-base sm:text-lg leading-relaxed">
                                        {block.content}
                                    </div>
                                </div>
                            </div>
